...
export const loginApi = (params: Login.ReqLoginForm) => {
  ...
  return http.post<Login.ResLogin>(`/admin/upms/login/doLogin`, params, { loading: false }); // 正常 post json 请求  ==>  application/json
...
export const getAuthMenuListApi = () => {
  ...
  return http.get<MenuItem>(`/admin/upms/login/getLoginInfo`, {}, { loading: false });
