...
export const globalTheme: Record<Theme.ThemeType, { [key: string]: string }> = {
  light: {
    ...
    //joncle
    "--hooks-colorBgToolbar": "#f4f4f4",
    "--hooks-colorBorderToolbar": "#f4f4f4",
  ...
  inverted: {
    ...
    //joncle
    "--hooks-colorBgToolbar": "#0d0d0d",
    "--hooks-colorBorderToolbar": "#0d0d0d",
